...
class KB_Categories extends Creative_Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'KB Categories', 'creative-addons-for-elementor' );
	}
	...
	protected function get_config_defaults() {
		return [
			...
			'crel_kbCategories__title_text'                     => esc_html__( 'Categories', 'creative-addons-for-elementor' ),
	...
	public function get_presets_options() {
		...
		$options['design-2'] = array(
			'title' => esc_html__( 'List Layout 2', 'creative-addons-for-elementor'),
		...
		$options['design-3'] = array(
			'title' => esc_html__( 'List Layout 3', 'creative-addons-for-elementor'),
		...
		$options['design-4'] = array(
			'title' => esc_html__( 'List Layout 4', 'creative-addons-for-elementor'),
		...
		$options['design-5'] = array(
			'title' => esc_html__( 'Box Layout 1', 'creative-addons-for-elementor'),
		...
		$options['design-6'] = array(
			'title' => esc_html__( 'Box Layout 2', 'creative-addons-for-elementor'),
		...
		$options['design-7'] = array(
			'title' => esc_html__( 'Box Layout 3', 'creative-addons-for-elementor'),
		...
		$options['design-8'] = array(
			'title' => esc_html__( 'Box Layout 4', 'creative-addons-for-elementor'),
		...
		$options['design-9'] = array(
			'title' => esc_html__( 'Box Layout 5', 'creative-addons-for-elementor'),
		...
		$options['design-10'] = array(
			'title' => esc_html__( 'Box Layout 6', 'creative-addons-for-elementor'),
	...
	protected function register_content_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Content', 'creative-addons-for-elementor' ),
			...
			$this->add_control(
				...
				[
					...
					'placeholder' => esc_html__( 'Type your text here', 'creative-addons-for-elementor' ),
					'condition'	=> [
						'crel_kbCategories__title_toggle'	=> 'yes'
					]
				]
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Show Categories', 'creative-addons-for-elementor' ),
					'type' => Controls_Manager::SELECT,
					'options' => array(
						'all' => esc_html__( 'All', 'creative-addons-for-elementor' ),
						'top' => esc_html__( 'Top', 'creative-addons-for-elementor' ),
					)
				]
			);
			...
			$this->add_control(
				'crel_kbCategories__categories_ids_text',
				[
					'label' => esc_html__( 'Category ID(s):', 'creative-addons-for-elementor' ),
					'type' => Controls_Manager::TEXT,
					'placeholder' => esc_html__( 'Add categories id, separated by comma', 'creative-addons-for-elementor' ),
				]
			);
	...
	protected function register_style_controls() {
	    ...
	    $this->start_controls_section(
			...
			$this->add_control(
				...
				[
					...
					'options' => [
						'flex-start' => [
							'title' => is_rtl() ? esc_html__( 'Right', 'creative-addons-for-elementor' ) : esc_html__( 'Left', 'creative-addons-for-elementor' ),
						...
						'flex-end' => [
							'title' => is_rtl() ? esc_html__( 'Left', 'creative-addons-for-elementor' ) : esc_html__( 'Right', 'creative-addons-for-elementor' ),
		...
		$this->start_controls_section(
				...
				[
						'label' => esc_html__( 'List', 'creative-addons-for-elementor' ),
						'tab' => Controls_Manager::TAB_STYLE,
				]
		);
			...
			$this->add_responsive_control(
				...
				[
					...
					'options' => [
						'col' => [
							'title' => esc_html__( 'Column', 'creative-addons-for-elementor' ),
							'icon' => 'eicon-editor-list-ul',
						],
						'row' => [
							'title' => esc_html__( 'Row', 'creative-addons-for-elementor' ),
			...
			$this->add_responsive_control(
					'crel_kbCategories__list_paddingTopBottom',
					[
							'label' => esc_html__( 'Space Between', 'creative-addons-for-elementor' ),
			...
			$this->add_responsive_control(
			    ...
			    [
				    'label' => esc_html__( 'Icon Position', 'creative-addons-for-elementor' ),
				    'type' => Controls_Manager::CHOOSE,
				    'label_block' => false,
				    'options' => [
					    'icon-first' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Category', 'creative-addons-for-elementor' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_group_control(
			...
			$this->add_control(
				...
				[
					'label'     => esc_html__( 'Fixed Width', 'creative-addons-for-elementor'),
					'type'      => Controls_Manager::SWITCHER,
					'label_on'  => esc_html__( 'Yes', 'creative-addons-for-elementor'),
					'label_off' => esc_html__( 'No', 'creative-addons-for-elementor'),
					'condition'	=> [
			...
			$this->add_control(
				'crel_kbCategories__cat_backgroundColorHover',
				[
					'label' => esc_html__( 'Hover Background Color', 'creative-addons-for-elementor' ),
					'type' => Controls_Manager::COLOR,
					'selectors' => [
		...
		$this->start_controls_section(
				...
				[
						'label' => esc_html__( 'Category - Icon', 'creative-addons-for-elementor' ),
						'tab' => Controls_Manager::TAB_STYLE,
				]
		);
			...
			$this->add_notice_control( sprintf( esc_html__( 'You can edit categories icons on the %1$s Knowledge Base Categories page %2$s', 'creative-addons-for-elementor' ),
									'<a href="' .esc_url( admin_url( $link_template ) ) . '" target="_blank">', '</a>' ), 'info', [], 'crel_kbCategories_redirect_to_category' );

			// Icon Size
			$this->add_responsive_control(
					'crel_kbCategories__icon_size',
					[
							'label' => esc_html__( 'Size', 'creative-addons-for-elementor' ),
							'type' => Controls_Manager::SLIDER,
							'range' => [
									'px' => [
											'min' => 6,
	...
	protected function render() {
		...
		$layout         = $settings['crel_kbCategories__list_layout'];
		$title_active   = $settings['crel_kbCategories__title_toggle'];
		$title_html_tag_escaped = $this->sanitize_html_tag( $settings['crel_kbCategories__title_HTMLTag'], 'h3' );
		$category_title = $settings['crel_kbCategories__title_text'];
	    $icon_loc       = $settings['crel_kbCategories__icon_position'];       ?>
		
		<div class="crel-kb-categories-list-container crel-kb-categories-list--<?php echo esc_attr( $layout ); ?> crel-kb-categories-list--<?php echo esc_attr( $icon_loc ); ?>">

			<div class="crel-kb-cat-list__inner"><?php
				
				if ( $title_active === 'yes' ) {
					echo '<' . esc_attr( $title_html_tag_escaped ) . ' class="crel-kb-cat-list-title" >' . esc_html( $category_title ) . '</' . esc_attr( $title_html_tag_escaped ) . '>';
				}
		            ...
		            echo esc_html__( 'Coming Soon', 'creative-addons-for-elementor' );
						...
						<ul class="crel-kb-cat-list-items-container">			        <?php
						   foreach( $terms as $category ) {
								...
								<!-- List Item -->
								<li id="<?php echo 'crel-cat-' . esc_attr( $category->term_id ); ?>" class="crel-kb-cat-list-item__item <?php echo esc_attr( $category_Level ); ?>">
    ...
    private function execute_search( $kb_id, $filter, $category_ids='' ) {
	    ...
	    if ( empty($category_ids) ) {
	    	if ( $filter == 'all' ) {
			    $args = array(
				    'taxonomy'   => KB_Handler::get_category_taxonomy_name( $kb_id ),
				    'orderby'    => 'name',
	...
	private function show_category_icon( $term_id, $categories_icons ) {
		...
		if ( $icon['type'] == 'font' ) {		
			...
			<span class="crel-kb-cat-list-items__item__icon"><img src="<?php echo esc_url( $icon['image_thumbnail_url'] ); ?>"></span><?php
		}
	}
}