...
class Steps extends Creative_Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Steps', 'creative-addons-for-elementor' );
	}
	...
	protected function get_config_defaults() {
		return [
			...
			// Content Tab -------------------------------------------------/
			'crel_steps__title_text'                                => esc_html__( 'Steps Title', 'creative-addons-for-elementor' ),
			'crel_steps__list_type' 		                        => 'crel-steps--decimal',
			'crel_steps__titlePrefix_text'                          => '',
			'crel_steps__titleHTML_tag'                             => 'h3',
			'crel_steps__list'   => [
				[
					'crel_steps__title_text'    => esc_html__( 'First Step', 'creative-addons-for-elementor' ),
					'crel_steps__desc_text'          => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Culpa enim esse excepturi nemo nesciunt officia officiis optio.', 'creative-addons-for-elementor' ),
				...
				[
					'crel_steps__title_text'    => esc_html__( 'Second Step', 'creative-addons-for-elementor' ),
					'crel_steps__desc_text'          => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Culpa enim esse excepturi nemo nesciunt officia officiis optio.', 'creative-addons-for-elementor' ),
					'crel_steps__layout_type' => 'layout-img-right',
					'crel_steps__structure' => 'structure-50-50',
					'crel_steps__image' => [
	...
	protected function get_presets_defaults() {
		return [
		 ...
		 // Content Tab -------------------------------------------------/
		 'crel_steps__title_text'                               => esc_html__( 'New Step', 'creative-addons-for-elementor' ),
		 'crel_steps__list_type' 		                        => 'crel-steps--decimal',
		 'crel_steps__titlePrefix_text'                         => '',
		 'crel_steps__titleHTML_tag'                            => 'h3',
		 'crel_steps__desc_text'                                => esc_html__( 'Instructions text', 'creative-addons-for-elementor' ),
	...
	public function get_presets_options() {
		...
		$options['design-3'] = array(
			'title' => esc_html__( 'Design 3', 'creative-addons-for-elementor' ),
		...
		$options['design-4'] = array(
			'title' => esc_html__( 'Design 4', 'creative-addons-for-elementor' ),
		...
		$options['design-5'] = array(
			'title' => esc_html__( 'Design 5', 'creative-addons-for-elementor' ),
			'preview_url' => $this->presets_preview_url( 'steps-design-5.jpg' ),
			'options' => array(

				'crel_steps__titlePrefix_text' => esc_html__( 'Step', 'creative-addons-for-elementor' ),
		...
		$options['design-6'] = array(
			'title' => esc_html__( 'Design 6', 'creative-addons-for-elementor' ),
		...
		$options['design-7'] = array(
			'title' => esc_html__( 'Design 7', 'creative-addons-for-elementor' ),
		...
		$options['design-8'] = array(
			'title' => esc_html__( 'Design 8', 'creative-addons-for-elementor' ),
		...
		$options['design-9'] = array(
			'title' => esc_html__( 'Design 9', 'creative-addons-for-elementor' ),
		...
		$options['design-10'] = array(
			'title' => esc_html__( 'Design 10', 'creative-addons-for-elementor' ),
		...
		$options['design-11'] = array(
			'title' => esc_html__( 'Design 11', 'creative-addons-for-elementor' ),
		...
		$options['design-12'] = array(
			'title' => esc_html__( 'Design 12', 'creative-addons-for-elementor' ),
		...
		$options['design-14'] = array(
			'title' => esc_html__( 'Design 13', 'creative-addons-for-elementor' ),
		...
		$options['design-15'] = array(
			'title' => esc_html__( 'Design 14', 'creative-addons-for-elementor' ),
		...
		$options['design-16'] = array(
			'title' => esc_html__( 'Design 15', 'creative-addons-for-elementor' ),
		...
		$options['design-17'] = array(
			'title' => esc_html__( 'Design 16', 'creative-addons-for-elementor' ),
		...
		$options['design-18'] = array(
			'title' => esc_html__( 'Design 17', 'creative-addons-for-elementor' ),
		...
		$options['design-19'] = array(
			'title' => esc_html__( 'Design 18', 'creative-addons-for-elementor' ),
		...
		$options['design-20'] = array(
			'title' => esc_html__( 'Design 19', 'creative-addons-for-elementor' ),
		...
		$options['design-21'] = array(
			'title' => esc_html__( 'Design 20', 'creative-addons-for-elementor' ),
		...
		$options['design-22'] = array(
			'title' => esc_html__( 'Design 21', 'creative-addons-for-elementor' ),
		...
		$options['design-23'] = array(
			'title' => esc_html__( 'Design 22', 'creative-addons-for-elementor' ),
	...
	protected function register_content_controls() {
	   ...
	   $this->add_control(
		   ...
		   [
			   'label'       	=> esc_html__( 'List Type', 'creative-addons-for-elementor'),
			   'type' 			=> Controls_Manager::SELECT,
			   'label_block' 	=> false,
			   'options' 		=> [
				   'crel-steps--decimal'  	                => esc_html__( 'Decimal ', 'creative-addons-for-elementor'),
				   'crel-steps--decimal-leading-zero' 	    => esc_html__( 'Decimal Leading Zero', 'creative-addons-for-elementor'),
				   'crel-steps--upper-alpha' 	            => esc_html__( 'Upper Alpha', 'creative-addons-for-elementor'),
				   'crel-steps--lower-alpha' 	            => esc_html__( 'Lower Alpha', 'creative-addons-for-elementor'),
				   'crel-steps--lower-roman' 	            => esc_html__( 'Lower Roman', 'creative-addons-for-elementor'),
				   'crel-steps--lower-greek' 	            => esc_html__( 'Lower Greek', 'creative-addons-for-elementor'),
				   'crel-steps--armenian' 	                => esc_html__( 'Armenian', 'creative-addons-for-elementor'),
				   'crel-steps--georgian' 	                => esc_html__( 'Georgian', 'creative-addons-for-elementor'),
			   ],
		   ]
	   );
	   ...
	   $this->add_control(
		   'crel_steps__titlePrefix_text',
		   [
			   'label'         => esc_html__( 'Title Prefix', 'creative-addons-for-elementor' ),
			   'type'          => Controls_Manager::TEXT,
			   'placeholder'   => esc_html__( 'Step', 'creative-addons-for-elementor' ),
			   'force_preset' => true
		   ]
	   );
	   ...
	   $this->add_control(
		   ...
		   [
			   'label' => esc_html__( 'Show Anchor Link', 'creative-addons-for-elementor'),
	   ...
	   $this->end_controls_section();
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Steps', 'creative-addons-for-elementor' ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
			...
			$repeater->start_controls_tabs(
				...
				$repeater->start_controls_tab(
					...
					$repeater->add_control(
							...
							[
								'label'         => esc_html__( 'Title', 'creative-addons-for-elementor' ),
								'type'          => Controls_Manager::TEXT,
								'default'   => esc_html__( 'NEW STEP', 'creative-addons-for-elementor' ),
							]
						);
					...
					$repeater->add_control(
						...
						[
							...
							'type'      => Controls_Manager::SELECT,
							'options'   => [
								'layout-img-top'   => esc_html__( 'Image above text', 'creative-addons-for-elementor' ),
								'layout-img-right' => is_rtl() ? esc_html__( 'Image left of text', 'creative-addons-for-elementor' ) : esc_html__( 'Image right of text', 'creative-addons-for-elementor' ),
								'layout-img-below' => esc_html__( 'Image below text', 'creative-addons-for-elementor' ),
								'layout-img-left'  => is_rtl() ? esc_html__( 'Image right of text', 'creative-addons-for-elementor' ) : esc_html__( 'Image left of text', 'creative-addons-for-elementor' ),
								'no-image'         => esc_html__( 'No Image', 'creative-addons-for-elementor' ),
							],
							'separator' => 'before',
					...
					$repeater->add_control(
						...
						[
							...
							'type'      => Controls_Manager::SELECT,
							'options'   => [
								'structure-50-50'   => esc_html__( 'Columns', 'creative-addons-for-elementor' ) . ' 50, 50',
								'structure-33-66'   => is_rtl() ? esc_html__( 'Columns', 'creative-addons-for-elementor' ) . ' 66, 33' : esc_html__( 'Columns', 'creative-addons-for-elementor' ) . ' 33, 66',
								'structure-66-33'   => is_rtl() ? esc_html__( 'Columns', 'creative-addons-for-elementor' ) . ' 33, 66' : esc_html__( 'Columns', 'creative-addons-for-elementor' ) . ' 66, 33',
								'structure-75-25'   => is_rtl() ? esc_html__( 'Columns', 'creative-addons-for-elementor' ) . ' 25, 75' : esc_html__( 'Columns', 'creative-addons-for-elementor' ) . ' 75, 25',
								'structure-25-75'   => is_rtl() ? esc_html__( 'Columns', 'creative-addons-for-elementor' ) . ' 75, 25' : esc_html__( 'Columns', 'creative-addons-for-elementor' ) . ' 25, 75',
							],
							'separator' => 'after',
				...
				$repeater->start_controls_tab(
					...
					$repeater->add_control(
						'crel_steps__block_id',
						[
							'label' => esc_html__( 'Block ID', 'creative-addons-for-elementor' ),
							'type' => Controls_Manager::TEXT,
							'placeholder' => esc_html__( 'title-1', 'creative-addons-for-elementor' ),
							'description' => esc_html__( 'This value will be used in the url for the section, like this: https://site.com/#title-1. Not required. By default, will use Heading Text', 'creative-addons-for-elementor' ),
						]
					);
	...
	protected function register_style_controls() {
		...
		$this->start_controls_section(
			...
			'crel_steps__list_spacing',
			[
				'label' => esc_html__( 'Space between each Step', 'creative-addons-for-elementor'),
		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				[
					...
					'label_block' 	=> false,
					'options' 		=> [
						'crel-step-header__inner--row'   => esc_html__( 'Row - All text in a Row', 'creative-addons-for-elementor'),
						'crel-step-header__inner--col'   => esc_html__( 'Col - Prefix + Number above Title', 'creative-addons-for-elementor'),
					],
					'separator'     => 'before'
				]
			);
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Middle Divider', 'creative-addons-for-elementor'),
					'type' => Controls_Manager::SWITCHER,
					'label_on'  => esc_html__( 'Yes', 'creative-addons-for-elementor'),
					'label_off' => esc_html__( 'No', 'creative-addons-for-elementor'),
				]
			...
			$this->add_responsive_control(
				'crel_steps__headerMiddleDivider_marginLeft',
				[
					'label' => esc_html__( 'Margin Left', 'creative-addons-for-elementor'),
					'type' => Controls_Manager::SLIDER,
					'range' => [
						'px' => [
							'min' => 0,
			...
			$this->add_responsive_control(
				'crel_steps__headerMiddleDivider_marginRight',
				[
					'label' => esc_html__( 'Margin Right', 'creative-addons-for-elementor'),
					'type' => Controls_Manager::SLIDER,
					'range' => [
						'px' => [
							'min' => 0,
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Prefix/Counter Container', 'creative-addons-for-elementor' ),
				'tab' => Controls_Manager::TAB_STYLE
			]
		);
			...
			$this->add_control(
				...
				[
					...
					'label_block' 	=> false,
					'options' 		=> [
						'crel-step-header__step--row'   => esc_html__( 'Row', 'creative-addons-for-elementor'),
						'crel-step-header__step--col'   => esc_html__( 'Col', 'creative-addons-for-elementor'),
					],
					'separator'     => 'before'
				]
			);
		...
		$this->start_controls_section(
			...
			'crel_steps__prefix_startingSpace',
			[
				'label' => esc_html__( 'Starting Space', 'creative-addons-for-elementor'),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => -200,
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Counter', 'creative-addons-for-elementor' ),
				'tab' => Controls_Manager::TAB_STYLE
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Anchor Link', 'creative-addons-for-elementor' ),
				'tab' => Controls_Manager::TAB_STYLE
			]
		);
			...
			$this->add_control(
				...
				[
					'label'       	=> esc_html__( 'Icon Visibility', 'creative-addons-for-elementor'),
					'type' 			=> Controls_Manager::SELECT,
					'label_block' 	=> false,
					'options' 		=> [
						'crel-steps--link-icon-show' 	    => esc_html__( 'Show all the time', 'creative-addons-for-elementor'),
						'crel-steps--link-icon-hover'     => esc_html__( 'Show On heading hover', 'creative-addons-for-elementor'),
					],
					'separator'     => 'before'
				]
			);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Body', 'creative-addons-for-elementor' ),
				'tab' => Controls_Manager::TAB_STYLE
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Text Editor', 'creative-addons-for-elementor' ),
				'tab' => Controls_Manager::TAB_STYLE
			]
		);
		...
		$this->add_control(
			...
			$this->add_responsive_control(
				'crel_steps__caption_marginTop',
				[
					'label' => esc_html__( 'Space Between Image', 'creative-addons-for-elementor'),
					'type' => Controls_Manager::SLIDER,
					'range' => [
						'px' => [
							'min' => -200,
	...
	protected function render_steps_image( $image_data, $item ) {
		...
		$caption = $item['crel_steps__caption_text'];
		...
		echo '<div class="crel-steps-img elementor-image">';
		    ...
		    if ( $caption ) { ?>
				...
				if ( $lightBox === 'yes' ) { ?>
					<a href="<?php echo esc_url( $image_full ); ?>" data-elementor-open-lightbox="yes" data-elementor-lightbox-title=" ">				<?php
				} ?>
					<span style="<?php echo esc_attr( $style ); ?>" class="crel-steps-img-wrap">
				...
				if ( $caption ) { ?>
					<figcaption class="crel-widget-image-caption crel-caption-text"><?php echo esc_html( $caption ); ?></figcaption>				<?php
				}
	...
	protected function render_steps_link( $heading_text ) {
		...
		$copy_text = sprintf( esc_html__( 'Copy link to this section: %1$s', 'creative-addons-for-elementor'), $heading_text );
		$copied_text = esc_html__( 'Copied to clipboard!', 'creative-addons-for-elementor');
		
		if ( $link_active === 'yes' ) { ?>
			<div class="crel-step-header__title__link" aria-label="<?php echo esc_attr( $copy_text ); ?>" data-copy_text="<?php echo esc_attr( $copy_text ); ?>" data-copied="<?php echo esc_attr( $copied_text ); ?>">
	...
	protected function render_steps_title( $title, $title_html_tag_escaped, $index, $i, $prefix ){
		...
		echo '<div class="crel-step-header__inner__title">' ?>
			<<?php echo esc_attr( $title_html_tag_escaped ); ?> <?php
				...
				echo $this->get_render_attribute_string( $field_key ); ?>>
				<span class="crel-hidden-title-prefix" aria-hidden="true"><?php echo esc_html( $prefix . ' ' . $i ); ?></span>
				<?php echo esc_html( $title ); ?>
			</<?php echo esc_attr( $title_html_tag_escaped ); ?>>
	...
	protected function render() {
		...
		$list_Types             = $settings['crel_steps__list_type'];
		$prefix                 = $settings['crel_steps__titlePrefix_text'];
		$title_html_tag_escaped = $this->sanitize_html_tag( $settings['crel_steps__titleHTML_tag'], 'h3' );
		$anchor_link_visibility = $settings['crel_steps__anchorLink_visibility'];
		$prefix_counter_layout  = $settings['crel_steps__prefixCounterContainer_layout'];
		$headerLayout           = $settings['crel_steps__header_layout']; 	?>

		<!-- Steps -->
		<div class="crel-steps-container <?php echo esc_attr( $list_Types . ' ' . $anchor_link_visibility ); ?> ">
		...
		foreach ( $settings['crel_steps__list'] as $key => $item ) :
			...
			<div class="crel-step elementor-repeater-item-<?php echo esc_attr( $item['_id'] ); ?>" id="<?php echo esc_attr( $titleID ); ?>" >
								...
								<div class="elementor-widget-wrap">
									<div class="elementor-element elementor-widget elementor-widget-heading">
										<div class="crel-step-header__inner <?php echo esc_attr( $headerLayout ); ?> crel-elementor-widget-container">
											...
											$this->render_steps_title( $item['crel_steps__title_text'], $title_html_tag_escaped, $key, $i,  $prefix ); ?>
				...
				<!----- BODY ---------------->
				<div class="crel-step-body crel-<?php echo esc_attr( $item['crel_steps__layout_type'] ); ?>">
					...
					<div class="crel-step-header"><div class="crel-row"><div class="elementor-element elementor-column elementor-col-100 elementor-top-column"><div class="crel-elementor-column-wrap  elementor-element-populated"><div class="elementor-widget-wrap"><div class="elementor-element elementor-widget elementor-widget-heading">
						<div class="crel-step-header__inner {{{ settings.crel_steps__header_layout }}} crel-elementor-widget-container">
							...
							<div class="crel-step-header__inner__title">  <#
								...
								let titleHtmlTag = settings.crel_steps__titleHTML_tag;
								...
								<{{{ titleHtmlTag }}} {{{ view.getRenderAttributeString( field_key ) }}}>{{{ item.crel_steps__title_text }}}</{{{ titleHtmlTag }}}><?php
								
								$copy_text = esc_html__( 'Copy link to this section: ', 'creative-addons-for-elementor' );
								$copied_text = esc_html__( 'Link copy on Preview not available', 'creative-addons-for-elementor'); ?><#
								
								
								if ( settings.crel_steps__anchorLink_toggle == 'yes' ) { #>
									<div class="crel-step-header__title__link" aria-label="<?php echo esc_attr( $copy_text ); ?>{{{ item.crel_steps__title_text }}}" data-copy_text="<?php echo esc_attr( $copy_text ); ?>{{{ item.crel_steps__title_text }}}" data-copied="<?php echo esc_attr( $copied_text ); ?>">
										...
										<div class="crel-step-header__title__link__icon_hover-popup">
											<div class="crel-step-header__title__link__icon_hover-popup__inner">
												<?php echo esc_html( $copy_text ); ?>{{{ item.crel_steps__title_text }}}
											</div>
										</div>
									</div>		<#
								} #>
